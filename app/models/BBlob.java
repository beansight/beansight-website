...
public class BBlob implements BinaryField, UserType {
    ...
    private BBlob(String UUID, String type) {
        this.UUID = UUID;
        this.type = type;
    }
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, Object o) throws HibernateException, SQLException {
        ...
        return new BBlob(val.split("[|]")[0], val.split("[|]")[1]);
    }

    public void nullSafeSet(PreparedStatement ps, Object o, int i) throws HibernateException, SQLException {
        if(o != null && ((BBlob)o).UUID!=null && !((BBlob)o).UUID.equalsIgnoreCase("null")) {
            ps.setString(i, ((BBlob)o).UUID + "|" + ((BBlob)o).type);
        } else {
    ...
    public Object deepCopy(Object o) throws HibernateException {
        ...
        return new BBlob(this.UUID, this.type);
    }
