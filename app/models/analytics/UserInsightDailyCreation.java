...
@Entity
public class UserInsightDailyCreation extends Model {
	...
	public UserInsightDailyCreation(Date forDate, User user, long count) {
		super();
	...
	public static boolean findIfAnalyticExistsForDate(Date date) {
		...
		if (UserInsightDailyCreation.count("forDate = ?", date) > 0) {
			return true;
		}
		return false;
	}
