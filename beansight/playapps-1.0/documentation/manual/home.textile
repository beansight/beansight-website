...
h2. <a>Download play-1.0.3</a>

For now only applications running on play-1.0.3 can be installed to playapps. Download the play-1.0.3 binary release at "http://www.playframework.org":http://www.playframework.org and "install it":http://www.playframework.org/documentation/1.0.3/install.
...
As you see, it contains the default configuration for the **playapps** environment. You can learn more about play environment management on the "corresponding playframework.org documentation page":http://www.playframework.org/documentation/1.0.3/ids.
